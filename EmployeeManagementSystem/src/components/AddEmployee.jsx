	...
	return (
		<div className='d-flex flex-column align-items-center pt-4'>
			...
			<div class="col-12">
					...
					<input type="text" class="form-control" id="inputName" placeholder='Enter  Full Name' autoComplete='off'
				...
				<div class="col-12 mb-3">
					<label class="form-label" for="inputGroupFile01">Select Picture</label>
